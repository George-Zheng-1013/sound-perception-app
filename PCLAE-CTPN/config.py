...
workspace = project_root  # 使用项目根目录
dataset_path = os.path.join(project_root, "dataset")  # 相对于项目的数据集路径
desed_folder = os.path.join(project_root, "DESED")  # 相对路径
